...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        navigate_home_action = QAction(QIcon(os.path.join('icons', 'cil-exit-to-app.png')),
                                            "Homepage", self)
        navigate_home_action.setStatusTip("Go to Timium Design Homepage")
        ...
        #label = Homepage
        self.add_new_tab(QUrl('https://www.qwant.com/'), 'Homepage')
    ...
    ##############################################
    # ADD NEW WEB TAB
    def add_new_tab(self, qurl=None, label="https://www.qwant.com/"):
        # Check if url value is blank
        if qurl is None:
            qurl = QUrl('https://www.qwant.com/')#pass empty string to url
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("https://fauux.neocities.org/"))
...
# APPLICATION NAME
app.setApplicationName("Timium Browser")
# APPLICATION COMPANY NAME
app.setOrganizationName("TimmyTM")
# APPLICATION COMPANY ORGANISATION
app.setOrganizationDomain("Timium.org")
